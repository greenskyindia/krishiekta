...
cmnd='''AT+CMGS="'''
full=cmnd+numb+'''"'''
#msg = "This text message from KrishiEkta has been sent through a computer program. Kindly acknowledge receipt at +91 9910236826"

msg = u"लगातार बारिश आयातित रबर की मांग तक जैक कर सकते हैं।"
#स्रोत: बिजनेस लाइन'''
...
if ser.isOpen():
	try:
		...
		#sio.write(unicode("\r"))		
		#sio.write(unicode("\r\n"))		
		#sio.write(unicode(msg+"\032"))
		ser.write((msg+"\032").encode('utf-8'))
		#ser.write("\r")
